...
import com.socialmedia.hichat.Activity.ImageViewerActivity;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        if(position>1){
            Message pm = userMessagesList.get(position-1);
            previousMsgDate = pm.getDate();
        }
        if (message.getDate().equals(previousMsgDate))
        {
            holder.date.setVisibility(View.GONE);
        }
        else
    ...
    {
        public TextView show_message,show_message_time,show_img_time,show_docx_time,date;
